...
sealed interface CallClaim {
     ...
     * 다시 보낸다. 부수효과는 한 번만 일어난다 (PLAN §5.4 F4·F6).
     */
 ...
 * - 부하 목표는 스테이션 20 대다 (PLAN §2 S4). 교환 1 건이 오가는 OCPP 메시지는
 *   `TC_S_103_CSMS` 기준 20 여 개(§7.1)이므로, 20 대 × 25 건 × 20 메시지 ≈ 10,000 이
