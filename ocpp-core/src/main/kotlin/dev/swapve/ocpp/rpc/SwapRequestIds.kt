...
/**
 * S02 원격 개시의 `requestId` 발번 (PLAN §4.4).
 *
 * ### ★ 여기서 §11.5 와 스키마가 정면으로 맞지 않는다
 *
 * PLAN §11.5 는 **"ID 는 시간순 정렬 가능한 값으로 생성 (UUIDv7 / TSID). 로컬 카운터 금지"**
