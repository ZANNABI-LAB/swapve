...
| **S6** | All of the above verified automatically by the gates | [README — how this is built](../README.md) | [`.github/workflows/ci.yml`](../.github/workflows/ci.yml) defines the gates and runs all six on every push |
