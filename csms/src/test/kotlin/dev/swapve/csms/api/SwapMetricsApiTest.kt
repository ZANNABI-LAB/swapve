...
/**
 * ★★ **성공 기준 S5 — 교환 성공률·소요시간·실패 사유가 REST 로 조회된다**.
 *
 ...
 * 클래스가 남긴 행과 같은 파일을 공유한다** (이것만 영속된다). 그건 결함이
...
class SwapMetricsApiTest {
    ...
    /**
     * ★ **실패 사유가 F1~F6 별로 구분된다** — *"실패 12건"은 정보가 아니다* (S5, 실패 시나리오).
     */
    @Test
