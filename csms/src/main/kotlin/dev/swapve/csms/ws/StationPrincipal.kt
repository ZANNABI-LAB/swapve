 ...
 *
 * 구현체 하나짜리 추상화는 두지 않지만 이건 인터페이스가 아니라 **데이터 타입
 * 하나**다. 보안 프로파일 가 명시적으로 요구한 유일한 경첩이고, 비용은 사실상 0 이다.
 *
...
/**
 * 신원 확인 수단 (보안 프로파일 1/2/3).
 *
 * 인증서 발급·CSR·키 저장소·`SecurityCtrlr` 은 **만들지 않는다** (보안 프로파일 "지금 하지 않을 것").
