 ...
 * **응답의 성격은 여전히 수신 확인**이다 — CALLERROR 가 아니다 (PLAN §4.3).
 */
data class BatteryRejection(val unknownSerials: List<String>) {

    /** 부록 `reason_codes.csv` 의 사전 정의 값 (PLAN §4.9.1). */
